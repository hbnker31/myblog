...
export default function Checkout() {
  ...
  return (
    <form
      className={cn('h96 w-full flex items-center justify-normal', {
    ...
    >
      <Button
        variant="ghost"
        className="flex flex-col p-10 gap-5 ring ring-purple-500"
      >
        <span className="flex items-center gap-2 text-2xl font-blod text-purple-500">
          <LightningBoltIcon
            className={cn(
              'h-5 w-5',
